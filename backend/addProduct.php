...
if(isset($_POST['submit'])){
    ...
    VALUES (Null,' $product_name','$fileName','$product_description','$product_price', '$product_priceNew','$product_conent')";
       ...
       <form action="" method="POST" enctype="multipart/form-data">
        <div class="card">
            ...
            <div class="card-body card-block">
                ...
                <div class="form-group"><label for="pricenNew" class=" form-control-label">Giá mới</label><input type="text" id="pricenNew" name="pricenNew" placeholder="" class="form-control"></div>
